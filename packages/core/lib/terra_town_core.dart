...
///   - src/landmark/   名所の収集判定（新規開示ヘクスの未収集POIから収集記録を
///                     組み立てる純粋関数）・CollectMethod・LandmarkCollectionRecord
///                     （T070・実装済み。Issue #159。ボーナスオブジェクトの判定・
///                     効果は未実装。landmark_service.dart 参照）
...
export 'src/landmark/landmark_service.dart';
